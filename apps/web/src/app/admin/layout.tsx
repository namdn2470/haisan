...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const toastCtx = {
    toasts,
    success: useCallback((m: string) => showToast('success', m), [showToast]),
    error: useCallback((m: string) => showToast('error', m), [showToast]),
    warning: useCallback((m: string) => showToast('warning', m), [showToast]),
    info: useCallback((m: string) => showToast('info', m), [showToast]),
  };
